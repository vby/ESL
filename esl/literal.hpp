...
#define ESL_IMPL_CHAR_LITERAL_CONSTANT(name, c)                                                                                                                \
    ...
    struct name;                                                                                                                                               \
    template <>                                                                                                                                                \
    struct name<char> : std::integral_constant<char, c> {};                                                                                                    \
    template <>                                                                                                                                                \
    struct name<wchar_t> : std::integral_constant<wchar_t, L##c> {};                                                                                           \
    template <>                                                                                                                                                \
    struct name<char16_t> : std::integral_constant<char16_t, u##c> {};                                                                                         \
    template <>                                                                                                                                                \
    struct name<char32_t> : std::integral_constant<char32_t, U##c> {};                                                                                         \
    template <class CharT>                                                                                                                                     \
    inline constexpr CharT name##_v = name<CharT>::value;
...
#define ESL_IMPL_STRING_LITERAL_CONSTANT(name, s)                                                                                                              \
    ...
    template <class CharT>                                                                                                                                     \
    inline constexpr typename name<CharT>::type name##_v = name<CharT>::value;
...
ESL_IMPL_STRING_LITERAL_CONSTANT(
    char128_constant, "\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0A\x0B\x0C\x0D\x0E\x0F\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x1A\x1B\x1C\x1D\x1E\x1F"
