...
public:
	...
	constexpr operator value_type() noexcept { return e_; }

	constexpr operator bool() noexcept { return static_cast<enum_underlying_type>(e_); }
};
...
inline constexpr bool is_same_bitmask_enum_v = is_bitmask_enum_v<T>
&& std::is_same_v<typename bitmask_enum_traits<T>::enum_type, typename bitmask_enum_traits<U>::enum_type>;
